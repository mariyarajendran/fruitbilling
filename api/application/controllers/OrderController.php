...
class OrderController extends API_Controller {
    ...
    public function postPendingHistoryData($order_summary_id, $data) {
       $order_pending_history_array = array(
        'order_summary_id' => $order_summary_id,
        'order_summary_pending_amount' => $data['total_amount'],
        'order_pending_history_received' => $data['received_amount'],
        'order_pending_history_pending' => $data['pending_amount']
    );
       return $order_pending_history_array;
   }
